...
const socialMediaLinks = [
  ...
  {
    name: "Gmail",
    link: "mailto:nasdaqpaul@gmail.com",
  ...
  {
    name: "WhatsApp",
    link: "https://api.whatsapp.com/send?phone=254743421389",
...
const skills = {
  data: [
    ...
    // },
    {
      ...
      skills: [
        "✔️ I build responsive frontend web applications using Angular and Flutter",
        // "⚡ Developing mobile applications using Flutter, React Native and solo android apps using Kotlin",
        "✔️ I create backend applications in Python (Flask, FastAPI, Django).",
    ...
    },
    {
      ...
      skills: [
        ...
        "✔️ I have experience with container technologies using Docker.",
        "✔️ I have experience with container orchestration using Docker Compose",
        "✔️ I have experience with automation using Jenkins",
...
const degrees = {
  degrees: [
    ...
    },
    {
      ...
      logo_path: "mksu_logo2.png",
      alt_name: "Machakos University",
      duration: "2016 - 2022",
      descriptions: [
        "⚡ I have an undergraduate certificate in CS with a second class upper"
        // "⚡ I have studied basic software engineering subjects like DS, Algorithms, DBMS, OS, CA, AI etc.",
        // "⚡ Apart from this, I have done courses on Deep Learning, Data Science, Cloud Computing and Full Stack Development.",
        // "⚡ I was selected for Merit cum Means Scholarship which is given to top 10% of students in college. I have received award from respected director for consistently best performance in academics.",
        // "You can just ignore this sentence. There is a bug in my code that requires one long sentence or else my layout does not work the way I want it to, so this is the sentence. It really needs to be long, so bare with me"
...
const certifications = {
  certifications: [
    ...
    },
    {
      ...
      certificate_link:
        "https://www.linkedin.com/learning/certificates/0def90d7825e434b7fdefa8923ca7b4764151121585542ffbfd5e6eb632dbc32",
      alt_name: "KNEC",
      color_code: "#ffffff"
    },
    {
      ...
      logo_path: "linkedin_learning.png",
      certificate_link:
        "https://www.linkedin.com/learning/certificates/4ba107b105589f0e4242971fbae31355bcfb080230741befdb1d2474eebdb3ff",
    ...
    },
    {
      ...
      logo_path: "linkedin_learning.png",
      certificate_link:
        "https://www.linkedin.com/learning/certificates/766d0241225a379a6a4448a0990d5e84caa716ecf0bf0ec5a6a2bddd7d771477",
      alt_name: "LinkedIn Learning",
      color_code: "#ffffff"
    },
    // {
...
const experience = {
  ...
  description:
    "I have had  a lot of work experience in a multitude of software projects, taking numerous roles in the projects from fullstack developer, to UI designer to product manager.",
      ...
      experiences: [
        {
          ...
          company: "ARC Ride",
          company_url: "https://www.arcrideglobal.com",
          logo_path: "arc_ride.webp",
          duration: "July 2022 - PRESENT",
          location: "Nairobi, Kenya",
          description:
            "I am currently a full stack software engineer at ARC Ride, an e-mobility company in Kenya."
        }
        // {
